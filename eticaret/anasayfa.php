<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	...
	<tr height="35">
		<td bgcolor="#004766" style="color: #FFFFFF; font-weight: bold;">&nbsp;En Yeni Ürünler</td>
	</tr>
				...
				?>
					<td width="205" valign="top">
						<table width="205" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;">
							...
							<tr height="25">
								<td width="205" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnYeniUrunSatirlari["id"]); ?>" style="color: #004766; font-weight: bold; text-decoration: none;"><?php echo  DonusumleriGeriDondur($EnYeniUrununTuru); ?></a></td>
							</tr>
							<tr height="25">
	...
	<tr height="35">
		<td bgcolor="#004766" style="color: #FFFFFF; font-weight: bold;">&nbsp;En Popüler Ürünler</td>
	</tr>
				...
				?>
					<td width="205" valign="top">
						<table width="205" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;">
							...
							<tr height="25">
								<td width="205" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnPopulerUrunSatirlari["id"]); ?>" style="color: #004766; font-weight: bold; text-decoration: none;"><?php echo  DonusumleriGeriDondur($EnPopulerUrununTuru); ?></a></td>
							</tr>
							<tr height="25">
	...
	<tr height="35">
		<td bgcolor="#004766" style="color: #FFFFFF; font-weight: bold;">&nbsp;En Çok Satan Ürünler</td>
	</tr>
				...
				?>
					<td width="205" valign="top">
						<table width="205" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;">
							...
							<tr height="25">
								<td width="205" align="center"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($EnCokSatanUrunSatirlari["id"]); ?>" style="color: #004766; font-weight: bold; text-decoration: none;"><?php echo  DonusumleriGeriDondur($EnCokSatanUrununTuru); ?></a></td>
							</tr>
							<tr height="25">
